...
export class AthomAppsAPI {
  ...
  transferAppToOrganization(opts: {
    appId: string;
  ...
  getAppPageviews(opts: { appId: string }): Promise<any>;

  getAppDriversStats(opts: { appId: string }): Promise<any>;

  getAppFlowCardsStats(opts: { appId: string }): Promise<any>;
  ...
  createOrganization(opts: { name?: string }): Promise<any>;

  getOrganization(opts: { orgId: string }): Promise<any>;

  deleteOrganization(opts: { orgId: string }): Promise<any>;

  updateOrganizationName(opts: {
    orgId: string;

    name?: string;
  }): Promise<any>;

  inviteMemberToOrganization(opts: {
    orgId: string;
  ...
  acceptMemberInviteToOrganization(opts: {
    orgId: string;

    inviteToken?: string;
  }): Promise<any>;

  updateMemberRoleInOrganization(opts: {
    orgId: string;
  ...
  removeMemberFromOrganization(opts: {
    orgId: string;
...
export class AthomCloudAPI {
  ...
  expireSelfHostedServerSubscriptions(): Promise<any>;
  ...
  getAppFlowCardsStatistics(): Promise<any>;
  ...
  verifyDelegationTokenCached(opts: {
    token: string;
