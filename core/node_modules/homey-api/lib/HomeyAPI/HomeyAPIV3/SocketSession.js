...
class SocketSession extends EventEmitter {
  ...
  async __connectHomeySocket(namespace, signal) {
    const homeySocket = this.__socket.io.socket(namespace);
    this.__homeySocket = homeySocket;
    this.__bindHomeySocket(namespace, homeySocket);
    ...
    await this.__waitForNamespaceStability(homeySocket, signal);
